...
AS BEGIN
	...
	BEGIN TRAN -----------------
		...
		INSERT INTO dbo.Account(UserID, Cert, Name, Age, Sex, UGradeID, PGradeID, RegDate, CCode)
		VALUES(@UserID, @Cert, @Name, @Age, @Sex, 0, 0, GETDATE(), @CCode);	

...
typedef struct IDirect3D9ExOverlayExtension *D3D9EXOVERLAYEXTENSION, *PDIRECT3D9EXOVERLAYEXTENSION;
...
typedef struct IDirect3DDevice9Video *D3DDEVICEVIDEO, *PDIRECT3DDEVICE9VIDEO;

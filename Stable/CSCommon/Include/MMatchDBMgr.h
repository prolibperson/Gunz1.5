...
public:
	...
	//bool GetLoginInfoForLauncher(const TCHAR* szUserID, unsigned int* poutnAID, TCHAR* poutPassword);
	...
	//Custom: Create account from login
	bool CreateAccountNew(const char* szUserName, const char* szPassword, const char* szEmail);
	//end;

...
void MAddSharedCommandTable(MCommandManager* pCommandManager, int nSharedType)
{
	...
	if(nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT){
		...
		C(MC_MATCH_CHECK_STAGEMODS,"","",MCDT_MACHINE2MACHINE);
			P(MPT_BLOB,"stageMods")
			P(MPT_UID,"player")
...
//			P(MPT_VECTOR, "Position")
		...
		C(MC_NEWQUEST_NPC_SPAWN,				"NewQuest.NPC.Spawn",	"NPC Spawn", MCDT_MACHINE2MACHINE)
			...
			P(MPT_UID, "uidNpc")
			P(MPT_STR, "szNpcDefName")	//todok 패킷 절약을 위해 문자열말고 enum값을 넘길 수 있게 하자
			P(MPT_UCHAR, "nSpawnType")			// NPC 스폰 종류 인덱스
			P(MPT_UCHAR, "PositionIndex")		// NPC 스폰 위치 인덱스
		...
		C(MC_NEWQUEST_REQUEST_NPC_SPAWN, "NewQuest.Request.NPCSpawn", "", MCDT_MACHINE2MACHINE)
			...
			P(MPT_UID, "uidNpc")
			P(MPT_INT, "nNum")
			P(MPT_STR, "szNpcDefName")	//todok 패킷 절약을 위해 문자열말컖Eenum값을 넘콅E펯E있게 하자
			P(MPT_SVECTOR, "Pos")
			P(MPT_SVECTOR, "Dir")
			P(MPT_INT, "route")
...
//	CA("connect", "Net.Connect");
	...
	C(MC_MATCH_REPORT, "Match.Report", "Player report", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "SenderName")
		P(MPT_STR, "TargetName")
		P(MPT_STR, "Message")
	//Custom: Gungame
	...
	C(MC_MATCH_GUNGAME_SET, "Set.ID", "Set ID", MCDT_MACHINE2MACHINE)
		P(MPT_BLOB, "itemSets")
	C(MC_MATCH_INFECT_PLAYER, "Infect.Player", "Infect Player", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidVictim")
		P(MPT_INT, "HP")
		P(MPT_INT, "AP")
		P(MPT_BOOL, "firstInfect")


	//newquest packets
	C(MC_BLITZ_START_HONOR,"","",MCDT_MACHINE2MACHINE)
		P(MPT_UID, "targetPlayer")
		P(MPT_INT, "startHonorValue")
	...
	C(MC_MATCH_LATEJOIN_QUEST,"","",MCDT_MACHINE2MACHINE)
		P(MPT_UID,"targetPlayer")
		P(MPT_INT,"currSector")

	C(MC_BLITZ_PLAYER_KILL, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidKiller")
		P(MPT_UID, "uidVictim")

	C(MC_BLITZ_REQUEST_UPGRADE, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_INT,"upgradeIndex")
		P(MPT_UINT,"currHonorPoints")

	C(MC_BLITZ_RESPONSE_UPGRADE, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID,"targetPlayer")
		P(MPT_INT, "keyIndex")
		P(MPT_INT, "honorCost")
		P(MPT_INT, "newUpgradeLevel")

	C(MC_BLITZ_REQUEST_CLASS, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "classID")

	C(MC_BLITZ_RESPONSE_CLASS, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID,"requester")
		P(MPT_INT,"classID")
	...
	//Custom: Antilead
	C(MC_GAME_ANTILEAD, "", "", MCDT_PEER2PEER)
		P(MPT_BLOB,"shotBlob")

	//Custom: Demolition

	C(MC_MATCH_REQUEST_PLANT_BOMB,"","",MCDT_MACHINE2MACHINE)
		P(MPT_UID,"planter")
	C(MC_MATCH_RESPONSE_PLANT_BOMB,"","",MCDT_MACHINE2MACHINE)
		P(MPT_INT,"teamID")
		P(MPT_BOOL,"isPlanted") //dual use, use this packet for both planting and removing
	C(MC_MATCH_BOMB_EXPLODE,"","",MCDT_MACHINE2MACHINE)
		P(MPT_INT, "winningTeam")

	C(MC_MATCH_INFECTION_LATEJOIN,"","",MCDT_MACHINE2MACHINE)
		P(MPT_UID,"targetPlayer")
		P(MPT_UID,"infectedPlayer")
		P(MPT_BOOL,"firstInfected")
	...
	C(MC_MATCH_REQUEST_CREATE_ACCOUNT, "Request.CreateAccount", "Creates a new Account", MCDT_MACHINE2MACHINE);
		P(MPT_STR, "Username");
		P(MPT_STR, "Password");
		P(MPT_STR, "Email");

...
rvector custCrossProduct(const rvector& v1, const rvector& v2)
{
	rvector result;
...
BOOL CWorldEditView::PreTranslateMessage(MSG* pMsg)
{
	rvector dir(0, 0, 0);
	rvector forward(0, 0, -1);
...
void CWorldEditView::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{

...
bool ZCharacterItem::Load(ZFile *file, int nReplayVersion)
{
	...
	enum MMatchCharItemParts_v1
	{
		...
		MMCIP_MELEE_V1 = 7,
		MMCIP_PRIMARY_V1 = 8,
		MMCIP_SECONDARY_V1 = 9,
		MMCIP_CUSTOM1_V1 = 10,
		MMCIP_CUSTOM2_V1 = 11,
		MMCIP_AVATAR_V1 = 12,
		MMCIP_COMMUNITY1_V1 = 13,
		MMCIP_COMMUNITY2_V1 = 14,
		MMCIP_LONGBUFF1_V1 = 15,
		MMCIP_LONGBUFF2_V1 = 16,
		MMCIP_END_V1
	};
	...
	struct Converter
	{
		...
		static int v6_to_v7(int v6)
		{
			switch (v6)
			{
			case MMCIP_HEAD_V1:			return MMCIP_HEAD;
			case MMCIP_CHEST_V1:		return MMCIP_CHEST;
			case MMCIP_HANDS_V1:		return MMCIP_HANDS;
			case MMCIP_LEGS_V1:			return MMCIP_LEGS;
			case MMCIP_FEET_V1:			return MMCIP_FEET;
			case MMCIP_FINGERL_V1:		return MMCIP_FINGERL;
			case MMCIP_FINGERR_V1:		return MMCIP_FINGERR;
			case MMCIP_MELEE_V1:		return MMCIP_MELEE;
			case MMCIP_PRIMARY_V1:		return MMCIP_PRIMARY;
			case MMCIP_SECONDARY_V1:	return MMCIP_SECONDARY;
			case MMCIP_CUSTOM1_V1:		return MMCIP_CUSTOM1;
			case MMCIP_CUSTOM2_V1:		return MMCIP_CUSTOM2;
			case MMCIP_AVATAR_V1:		return MMCIP_AVATAR;
			case MMCIP_COMMUNITY1_V1:   return MMCIP_COMMUNITY1;
			case MMCIP_COMMUNITY2_V1:	return MMCIP_COMMUNITY2;
			case MMCIP_LONGBUFF1_V1:	return MMCIP_LONGBUFF1;
			case MMCIP_LONGBUFF2_V1:	return MMCIP_LONGBUFF2;
			}
			return MMCIP_END;
		}
		...
		static int convert(int old, int nReplayVersion)
		{
			...
			case 0:case 1:case 2:case 3:case 4:case 5:
				curr = v0_to_v6(curr);break;
			case 6:
				curr = v6_to_v7(curr);break;
			}
			return curr;
		}
	};
	...
	else if (nReplayVersion == 6)
		numCharItemParts = MMCIP_END_V1;
	else

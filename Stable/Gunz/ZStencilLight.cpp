...
void ZStencilLight::PreRender()
{
	...
	pLPDIRECT3DDEVICE9->SetFVF( LIGHT_BSP_FVF );
	...
	pLPDIRECT3DDEVICE9->SetSamplerState( 0, D3DSAMP_ADDRESSU, D3DTADDRESS_CLAMP );
	pLPDIRECT3DDEVICE9->SetSamplerState( 0, D3DSAMP_ADDRESSV, D3DTADDRESS_CLAMP );

	pLPDIRECT3DDEVICE9->SetTextureStageState( 1, D3DTSS_COLORARG1, D3DTA_TEXTURE );
	pLPDIRECT3DDEVICE9->SetTextureStageState( 1, D3DTSS_COLOROP,   D3DTOP_MODULATE);
	pLPDIRECT3DDEVICE9->SetTextureStageState( 1, D3DTSS_COLORARG2, D3DTA_CURRENT );
	pLPDIRECT3DDEVICE9->SetTextureStageState( 1, D3DTSS_ALPHAARG1, D3DTA_CURRENT );
	pLPDIRECT3DDEVICE9->SetTextureStageState( 1, D3DTSS_ALPHAOP,   D3DTOP_SELECTARG1);

	/*
	pLPDIRECT3DDEVICE9->SetSamplerState( 1, D3DSAMP_ADDRESSU, D3DTADDRESS_CLAMP );
	pLPDIRECT3DDEVICE9->SetSamplerState( 1, D3DSAMP_ADDRESSV, D3DTADDRESS_CLAMP );
	...
	*/
	...
	pLPDIRECT3DDEVICE9->SetRenderState( D3DRS_AMBIENT, 0);
//	pLPDIRECT3DDEVICE9->SetLight( 0, pLight );
//	pLPDIRECT3DDEVICE9->LightEnable( 0, TRUE );
	pLPDIRECT3DDEVICE9->LightEnable( 0, FALSE );
	pLPDIRECT3DDEVICE9->LightEnable( 1, FALSE );
	pLPDIRECT3DDEVICE9->SetRenderState( D3DRS_LIGHTING, FALSE );
	//  pLPDIRECT3DDEVICE9->SetRenderState(D3DRS_NORMALIZENORMALS, TRUE );
	...
	pLPDIRECT3DDEVICE9->SetRenderState(D3DRS_DESTBLEND, D3DBLEND_ONE);

#ifdef _PUBLISH
	// 멀티패스 이므로 맨위의 폴리곤과 z값이 같을때만 그리면된다
	pLPDIRECT3DDEVICE9->SetRenderState(D3DRS_ZENABLE, true );
	//TODO: ask gunblade if this is okay to do
	//pLPDIRECT3DDEVICE9->SetRenderState(D3DRS_ZFUNC, D3DCMP_EQUAL );
#endif
...
void ZStencilLight::PostRender()
{
	...
	pLPDIRECT3DDEVICE9->SetRenderState(D3DRS_ZFUNC, D3DCMP_LESSEQUAL );
	...
	pLPDIRECT3DDEVICE9->SetSamplerState( 0, D3DSAMP_ADDRESSU, D3DTADDRESS_WRAP );
	pLPDIRECT3DDEVICE9->SetSamplerState( 0, D3DSAMP_ADDRESSV, D3DTADDRESS_WRAP );

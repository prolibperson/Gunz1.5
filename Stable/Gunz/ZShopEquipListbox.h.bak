...
void ShopPurchaseLadderItemListBoxOnDrop(void* pSelf, MWidget* pSender, MBitmap* pBitmap, const char* szString, const char* szItemString);
...
MListener* ZGetShopListSubFilterListener(void);
MListener* ZGetEquipListSubFilterListener(void);
...
MListener* ZGetShopPurchaseLadderItemListBoxListener(void);

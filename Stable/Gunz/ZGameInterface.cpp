...
//#endif
	...
	m_pLoginBG = new MBitmapR2; //nullptr
	bool bRead = false;
	...
	// ����A����e �������� ��AAIA�� A����A��U.
	if ( !bRead)
		bRead = m_pLoginBG->Create( "loginbg.png", RGetDevice(), "Interface/default/loading/loading_adult.jpg");
...
//#endif
	...
	//m_IDLResource.FindWidget("ServerAddress")->SetText("74.6");

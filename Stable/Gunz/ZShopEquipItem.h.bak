...
public:
	...
	virtual bool CanSendAccount() { return true; }
	virtual bool CanSell() { 
//#ifndef _SELL_CASHITEM
...
public:
	...
	virtual bool GetRentalHour(int& out_nRentalHour) = 0;
	virtual const char* GetPriceText(char* szBuf);
...
public:
	...
	bool GetPrice( int& out_nPrice );
	bool GetRentalHour( int& out_nRentalHour );
	virtual void Buy();
...
public:
	...
	bool GetPrice( int& out_nPrice ) { return false; }
	bool GetRentalHour( int& out_nRentalHour ) { return false; }
	virtual void Buy();
};

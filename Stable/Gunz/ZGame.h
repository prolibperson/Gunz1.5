...
#define PEERMOVE_TICK			100		 // 30// 0.1초 마다 이동메세지를 보낸다 (초당 10회)
#define PEERMOVE_AGENT_TICK		100		// 30// Agent를 통하면 초당 10번 메시지를 보낸다.
...
public:
	...
	void RSetFOV(unsigned short nFrameLimit);
	...
	//void RSetFOV(unsigned short nUpdateLimit = 0);

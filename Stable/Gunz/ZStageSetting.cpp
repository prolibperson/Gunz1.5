...
/////////////////////////////////////////////////////////////////////////////////
	...
	if ( pCBType && (pCBType->GetCount() > 0))
	{
		...
		if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_DEATHMATCH_SOLO)) == 0)
			...
			nGameType = 12;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()),"GunGame") == 0)
			nGameType = 15;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()),"SpyMode") == 0)
			nGameType = 16;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), "Challenge Quest") == 0)
			nGameType = 17;
		else if (strcmp(pCBType->GetString(pCBType->GetSelIndex()), "Infection") == 0)
			nGameType = 18;
	}

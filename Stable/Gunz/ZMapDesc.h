...
enum ZMapSpawnType
{
	...
	// 신규 퀘스트용
	ZMST_NPC_CUSTOM,	// <-실제 더미노드 이름으로 구분한다
	ZMST_SPAWN_BARRICADE_RED,
	ZMST_SPAWN_BARRICADE_BLUE,
	ZMST_SPAWN_GUARDIAN,
	ZMST_SPAWN_RADAR_RED,
	ZMST_SPAWN_RADAR_BLUE,
	ZMST_ROUTE,
	ZMST_SPAWN_TRESURE,
...
//	ZMapSpawnList	m_TeamSpawns[MMATCH_TEAM_MAX_COUNT];
	...
	rvector GetClosestRoutePos(const rvector& currPosition);

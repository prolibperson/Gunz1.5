...
struct ZCONFIG_AUDIO{
	...
	int	 nCustomMusicFolders;
	bool bCustomMusicEnabled;
	char defaultMusicPath[MAX_PATH * 2];
...
public:
	int					m_previousScreenMode;
protected:
	void ParseLocaleSelectableLanguages(rapidxml::xml_node<>* selectableLangsElem);
...
public:
	...
	bool Save( const char* fileName,const char* szHeader)	{ return SaveToFile(fileName, szHeader); }
...
#define MOUSE_SENSITIVITY_SNIPER 5000
...
#define ZTOK_VIDEO_FULLSCREEN			"SCREENMODE"
...
#define ZTOK_VIDEO_STENCILBUFFER		"STENCILBUFFER"
...
//Custom: New Config Options
#define ZTOK_CUSTOM					"CUSTOM"
#define ZTOK_CUSTOM_DISABLE_SW		"DISABLE_SW"
#define ZTOK_CUSTOM_TRAIL_OPTION		"TRAILOPTION"	//Trail Option
#define ZTOK_CUSTOM_OVERLAY_OPTION		"FPSOVERLAY"
// Variables
...
#define Z_AUDIO_BACKGROUNDAUDIO (ZGetConfiguration()->GetAudio()->enableBackGroundAudio)
...
#define Z_VIDEO_HPAP      		(ZGetConfiguration()->GetVideo()->bHPAP)
...
#define Z_ETC_FOV				(ZGetConfiguration()->GetVideo()->nFOV)
//Custom: Input Rate

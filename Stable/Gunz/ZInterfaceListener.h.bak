...
//Custom: spymode
DECLARE_LISTENER(ZGetSpyBanMapBoxOpen)
DECLARE_LISTENER(ZGetSpyBanMapBoxClose)
...
DECLARE_LISTENER(ZGetAllLadderEquipmentListCallerButtonListener)			// 캐쉬샵 버튼
...
DECLARE_LISTENER(ZGetEquipmentShopCallerButtonListener);			// Equipment to Shop
DECLARE_LISTENER(ZGetShopEquipmentCallerButtonListener)				// Shop to Equipment
...
DECLARE_LISTENER(ZGetBlitzBlueGladiatorListener);
DECLARE_LISTENER(ZGetBlitzRedGladiatorListener);

DECLARE_LISTENER(ZGetBlitzBlueHunterListener);
DECLARE_LISTENER(ZGetBlitzRedHunterListener);


DECLARE_LISTENER(ZGetBlitzBlueTerroristListener);
DECLARE_LISTENER(ZGetBlitzRedTerroristListener);

================================================================================
              MFC 라이브러리 : ItemThumbnailGenerator 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 ItemThumbnailGenerator 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 ItemThumbnailGenerator 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.

ItemThumbnailGenerator.vcproj
    응용 프로그램 마법사를 사용하여 생성된 VC++ 프로젝트의 주 프로젝트 파일입니다.
    이 파일에는 파일을 생성한 Visual C++ 버전 정보 및 응용 프로그램 마법사에서 선택한 플랫폼,
    구성, 프로젝트 기능 등의 정보가 포함됩니다.

ItemThumbnailGenerator.h
    응용 프로그램의 주 헤더 파일입니다. 이 파일에는 다른 프로젝트에 관련된 Resource.h와 같은
    특정 헤더가 포함되며 CItemThumbnailGeneratorApp 응용 프로그램 클래스가 선언됩니다.

ItemThumbnailGenerator.cpp
    CItemThumbnailGeneratorApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.

ItemThumbnailGenerator.rc
...
res\ItemThumbnailGenerator.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 ItemThumbnailGenerator.rc에 포함됩니다.

res\ItemThumbnailGenerator.rc2
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 ItemThumbnailGenerator.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

MainDoc.h, MainDoc.cpp - 문서
    CMainDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CMainDoc::Serialize 사용).
MainView.h, MainView.cpp - 문서 뷰
    CMainView 클래스를 포함하는 파일입니다.
    CMainView 개체를 사용하여 CMainDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////

기타 표준 파일

StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) ItemThumbnailGenerator.pch 및 미리 컴파일된

...
//#define CELL_SIZE		16	//큰 폰트를 소화하기 위해서 이제는 16으로 고정할 수 없다. 가변적으로 바뀌어야할 것이다.
...
//	m_nSamplingMultiplier = nSamplingMultiplier;	// 한방향 샘플링 횟수, 2이면 2*2크기를 샘플링한다.
	...
	m_hFont = CreateFont(-(m_nHeight - 4), 0, 0, 0, bBold==true?FW_NORMAL:FW_NORMAL, bItalic==true?TRUE:FALSE,
		FALSE, FALSE, DEFAULT_CHARSET, OUT_DEVICE_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH , szFontName);//FW_BOLD
...
//		m_pLPDIRECT3DDEVICE9->ApplyStateBlock(m_dwStateBlock);
}
*/

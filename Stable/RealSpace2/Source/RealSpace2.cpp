...
//	mlog("multithread.\n");
	...
	// ÀÌ ÇÃ·¡±×´Â device ¸¦ ¿©·¯ ¾²·¹µå¿¡¼­ ¾µ¶§ »ç¿ëÇÑ´Ù. ÆÛÆ÷¸Õ½º ÀúÇÏ°¡ ÀÖ´Ù.
...
#	//define _NVPERFHUD
	...
	// 'NVIDIA NVPerfHUD' ¾î´ðÅÍ¸¦ Ã£¾Æº¸°í, ÀÖÀ¸¸é µðÆúÆ® ¼¼ÆÃ ´ë½Å ±×°ÍÀ» »ç¿ëÇÑ´Ù.
...
// ¸Þ¸ð¸®¸¦ »õ·Î ÇÒ´çÇÏ¹Ç·Î ´Ù ¾²¸é Áö¿öÁà¾ßÇÑ´Ù.
